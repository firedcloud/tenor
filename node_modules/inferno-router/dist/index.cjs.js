...
var pathToRegexp = require('path-to-regexp-es6');
var hoistNonReactStatics = require('hoist-non-inferno-statics');
...
function combinePath(ref) {
    var pathname = ref.pathname; if ( pathname === void 0 ) pathname = '/';
    var search = ref.search; if ( search === void 0 ) search = '';
...
var Router = /*@__PURE__*/(function (Component) {
    ...
    Router.prototype.getChildContext = function getChildContext () {
        ...
        childContext.route = {
            ...
            match: (_a = this.state) === null || _a === void 0 ? void 0 : _a.match
        };
        return {
            router: childContext
        };
    ...
    Router.prototype.componentWillMount = function componentWillMount () {
        ...
        this.unlisten = history.listen(function () {
            this$1$1.setState({
                match: this$1$1.computeMatch(history.location.pathname)
            });
        });
    };
...
var StaticRouter = /*@__PURE__*/(function (Component) {
    function StaticRouter() {
        ...
        this.createHref = function (path) { return addLeadingSlash((this$1$1.props.basename || '') + createURL(path)); };
        this.handlePush = function (location) {
            var ref = this$1$1.props;
