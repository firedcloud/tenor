...
export interface IComponent<P, S> {
    ...
    render(nextProps: Readonly<{
        children?: Inferno.InfernoNode;
    } & P>, nextState: S, nextContext: any): Inferno.InfernoNode;
}
...
export declare namespace Inferno {
    ...
    interface StatelessComponent<P = {}> {
        ...
        }, context?: any): InfernoElement | null;
...
declare type InfernoManagedAttributes<C, P> = C extends {
...
declare global {
    namespace JSX {
        ...
        interface ElementClass extends IComponent<any, any> {
            render(nextProps: any, nextState: any, nextContext: any): Inferno.InfernoNode;
        }
        ...
        interface IntrinsicElements {
            ...
            animate: Inferno.SVGProps<SVGElement>;
            animateMotion: Inferno.SVGProps<SVGElement>;
            animateTransform: Inferno.SVGProps<SVGElement>;
