...
class LinkTag extends CustomComponent {
    render() {
        ...
        return ( <
            ...
            style = {
                {
                    backgroundImage: `linear-gradient(rgba(23,23,23,0.5), rgba(23,23,23,0.5)), ${escapeQuotes(`url("${image}")`)}`,
                }
            } >
            <
            span className = "term" > {
...

            {
                ...
                div className = "container" > {
                        ...
                        div className = "content" > {
                            this.user.partnercategories && this.user.partnercategories.map((category, i) => {
