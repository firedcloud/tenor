...
@subscribe({
    ...
    stickers: ['api.stickers.searchByUsername.*', 'username', 'section', 'ownsProfile'],
})
export class UserProfilePage extends BaseProfilePage {
    renderPage() {
        ...
        this.noindex = true;
        const noUploads = this.props.gifs.loaded && !this.gifList.length && this.props.stickers.loaded && !this.stickerList.length;

        this.profilePageView = this.props.section === this.PROFILE && !this.props.mediatype;
        this.favoritesPageView = this.props.section === this.FAVORITES && !this.props.mediatype;
        ...
        return ( <
            ...
            /Metadata> <
            div className = {
                `ProfilePage page${this.props.ownsProfile ? ' self' : ''}`
            } >
            <
            ...
            div className = "container" > {
                ...
                div className = "content" > {
                    ...
                    <
                    a onClick = {
                        () => this.setSection(this.FAVORITES)
                    } > {
                    ...
                    height = "130" / >
                        <
                        h2 > {
                            gettextSub('Upload your favorite GIFs!')
                        } < /h2> <
                        p > {
