...
import {
    isSticker
} from '../../common/util/isSticker';
import {
    MEDIA_TYPE
} from '../components/GifConstants';

export default function mathService({
    element,
    staticColumns
}) {
    let y;
    ...
    function resetVars() {
        ...
        containerWidth = element && element.offsetWidth ? (element.offsetWidth - paddingLeft - paddingRight - borderLeft - borderRight) : DEFAULT_WIDTH;
